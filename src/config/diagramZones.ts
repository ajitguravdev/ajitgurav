...
export interface StyleZone {
  ...
  colEnd: number;
  className: string;
  // 🔴 FIX: TypeScript ला सांगणे की matchValue असू शकते (optional), आणि ती Regex किंवा String असेल
  matchValue?: RegExp | string; 
  tooltip?: string; // 🔴 नवीन: माऊस नेल्यावर दिसणारी माहिती
}

// इथे आपण सर्व डायग्राम्सचे नियम ID नुसार ठेवणार आहोत
export const diagramZones: Record<string, StyleZone[]> = {
